  ...
  methods: {
    ...
    resolver(values) {
      ...
      if (!values.emailAddress) {
        ...
        errors.emailAddress = [
          { message: "Email address must be at most 50 characters long." },
        ];
      }
      ...
      if (!values.companyName) {
        ...
        errors.companyName = [
          { message: "Company name must start with a letter or number." },
        ];
      } else if (!/[a-zA-Z0-9]$/.test(values.companyName)) {
        errors.companyName = [
          { message: "Company name must end with a letter or number." },
        ];
      }
